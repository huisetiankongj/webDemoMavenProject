...
//        },
    ...
    function addFile( file ) {
    	var url = rootPath +"com/czx/baidu/webuploader/img/doc2.png"
        var $li = $( '<li id="' + file.id + '" style="background:url('+url+')">' +
    ...
    uploader.onFileDequeued = function( file ) {
        ...
        removeFile( file );
        updateTotalProgress();
        delete returnObj[file.name];
    }
    uploader.on( 'uploadSuccess',function(file,data){
    	returnObj[file.name] = data._raw;
    });
    ...
    $("#btn1").click(function(){
    	var url = rootPath + "web/findDBData.do";
    	$.ajax({
    		url : url,
    		type : "post",
    		dataType:"json",
